...
from src.utils import fetch_product_name_from_cloud
from src.data_report.generate_data_report import DashboardGenerator


# the analysis will be generated from the data in the mongdb 
mongo_con = MongoIO()
...
# if there is  no data below method will work
