...
class ScrapeReviews:
    def __init__(self,
                 product_name:str,
                 no_of_products:int):
        options = Options()  # here we have not used any option method we have set it to default only
    ...
    def scroll_to_load_reviews(self):
        # this method: used to read long long reviews of a particular product
